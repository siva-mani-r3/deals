  ...
  return (
    <div className='imageslider' style={{ "marginTop": "90px" }}>
      <Carousel activeIndex={index} onSelect={handleSelect} >
        <Carousel.Item>
          <img src='4.jpeg' style={{ "width": "100%", "height": "100%" }} text="First slide" class='img-fluid' />

        </Carousel.Item>
        <Carousel.Item>
          <img src='2.jpeg' style={{ "width": "100%", "height": "100%" }} text="Second slide" class='img-fluid' />
    
        </Carousel.Item>
        <Carousel.Item>
          <img src='3.jpeg' style={{ "width": "100%", "height": "100%" }} text="Third slide" className='img-fluid' />
        </Carousel.Item>
      </Carousel>
      <div className='conatiner-fluid'>
        <div className='row'>
         ...
         <center><a href='https://www.aec.edu.in/?p=Hostels' target='_blank' ><Button variant="outline-info" style={{"margin":"15px"}}>Hostel Facilities</Button></a></center>
            {/* <h6 style={{"margin":"10px","color":"grey"}}>
      ...
      <div className='container-fluid mt-3'>
        <div className='row'>
          <div className='col-md-12'>
            <img src='footer.jpeg' className='img-fluid' style={{width:"100%"}}/>
          </div>
        </div>
      </div>
    </div>
